...
[![Build Status](https://travis-ci.org/FountainJS/generator-fountain-choo.svg?branch=master)](https://travis-ci.org/FountainJS/generator-fountain-choo)
[![codecov](https://codecov.io/gh/FountainJS/generator-fountain-choo/branch/master/graph/badge.svg)](https://codecov.io/gh/FountainJS/generator-fountain-choo)

# Fountain Choo.js Generator

:steam_locomotive::train::train::train::train::train:

[![Choo](http://fountainjs.io/assets/imgs/choo.png)](https://github.com/yoshuawuyts/choo)

> This Yeoman generator allows you to start an Choo.js web app with the best Developer Experience out of the box!
...
## Generator Fountain Choo structure
...
##### Install `generator-fountain-choo`:
```
npm install -g generator-fountain-choo
```
...
##### Run `yo fountain-choo`, and select desired technologies:
```
yo fountain-choo
```
#### Use NPM scripts
...
```
yo fountain-choo:component --name myComponent --dir components/game
```

### [Start development](http://fountainjs.io/doc/usage/#use-npm-scripts)


## [Changelog](https://github.com/FountainJS/generator-fountain-choo/releases)
